  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Total Customers",  value: all.length,           sub: "all types",             icon: Users,     color: "bg-violet-50 border-violet-100", iconBg: "bg-violet-100", iconColor: "text-violet-600" },
          { label: "Business",         value: business.length,      sub: "corporate clients",     icon: Building2, color: "bg-blue-50 border-blue-100",     iconBg: "bg-blue-100",   iconColor: "text-blue-600"   },
          { label: "Individual",       value: individual.length,    sub: "personal accounts",     icon: User,      color: "bg-emerald-50 border-emerald-100",iconBg: "bg-emerald-100",iconColor: "text-emerald-600"},
          { label: "Total Outstanding",value: formatCurrency(totalBal), sub: "receivable balance",icon: Wallet,    color: "bg-amber-50 border-amber-100",   iconBg: "bg-amber-100",  iconColor: "text-amber-600"  },
