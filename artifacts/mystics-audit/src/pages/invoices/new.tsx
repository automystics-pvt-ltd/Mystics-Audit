                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b border-gray-100">
                    <tr>
                      ...
                      {settings.showDiscount && <th className="px-3 py-2.5 text-xs font-bold text-gray-500 w-16 text-right">Disc%</th>}
                      <th className="px-3 py-2.5 text-xs font-bold text-gray-500 w-20 text-right">GST%</th>
                      <th className="px-3 py-2.5 text-xs font-bold text-gray-500 w-28 text-right">Total</th>
                    ...
                    {lines.map((line, i) => {
                      ...
                      return (
                        <tr key={i} className="border-b border-gray-50 hover:bg-gray-50/60 group">
                          ...
                          {settings.showHsn && (
                            <td className="px-2 py-1.5">
                              <Input className="h-8 text-xs rounded-lg font-mono" value={line.hsnSac}
                          ...
                          {settings.showDiscount && (
                            <td className="px-2 py-1.5">
                              <Input className="h-8 text-sm rounded-lg text-right" type="number" min={0} max={100}
                          ...
                          <td className="px-3 py-1.5 text-right font-semibold text-gray-800 text-sm">{formatCurrency(c.total)}</td>
                          <td className="px-2 py-1.5">
