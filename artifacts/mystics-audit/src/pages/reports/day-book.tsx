  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: "Transactions", value: String(entries.length),     icon: Activity,       bg: "bg-violet-600" },
          { label: "Total Debit",  value: formatCurrency(totalDebit), icon: ArrowUpCircle,  bg: "bg-blue-600" },
          { label: "Total Credit", value: formatCurrency(totalCredit),icon: ArrowDownCircle,bg: "bg-emerald-600" },
