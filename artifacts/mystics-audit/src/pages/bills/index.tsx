  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Total Billed",   value: formatCurrency(totalAmount), sub: `${all.length} bills`,          icon: FileText,    color: "bg-violet-50 border-violet-100", iconBg: "bg-violet-100", iconColor: "text-violet-600" },
          { label: "Draft",          value: formatCurrency(draftAmt),    sub: `${all.filter(b=>b.status==="draft").length} bills`, icon: Clock,      color: "bg-gray-50 border-gray-200",     iconBg: "bg-gray-100",   iconColor: "text-gray-500"   },
          { label: "Pending Payment",value: formatCurrency(pendingAmt),  sub: `${overdueCount} overdue`,      icon: AlertTriangle,color: "bg-amber-50 border-amber-100",  iconBg: "bg-amber-100",  iconColor: "text-amber-600"  },
          { label: "Paid",           value: formatCurrency(paidAmt),     sub: `${all.filter(b=>b.status==="paid").length} bills`, icon: CheckCircle2,color: "bg-emerald-50 border-emerald-100",iconBg:"bg-emerald-100",iconColor:"text-emerald-600"},
